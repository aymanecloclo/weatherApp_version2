...
const WeatherMap = ({ city }) => {
    ...
    return (
<<<<<<< HEAD
        <div className="md:w-8/12 w-full  md:mx-auto bg-white shadow-2xl rounded-3xl p-6 pt-0 md:h-[%30]  " >
=======
        <div className="md:w-8/12 w-full  md:mx-auto bg-white shadow-lg rounded-lg p-6 pt-0 h-[%30] " >
