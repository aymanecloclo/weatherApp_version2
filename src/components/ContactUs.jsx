const ContactUs=()=>{
    ...
    return(
        ...
        <div class=" px-20 bg-white rounded-3xl grid sm:grid-cols-2 items-start gap-16 p-4  md:pt-20 mx-auto  font-[sans-serif] lg:w-7/12  z-50 transition-transform duration-300 transform hover:scale-105 ">
            <div>
